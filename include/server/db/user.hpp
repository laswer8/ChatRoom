...
//     string state;
// public:
//     _User(const int& _id=-1,const string& _name="",const string& _username="",const string& _pwd="",const string& _email="",const string& _phone="",const string& _state = "offline"):id(_id),name(_name),username(_username),password(_pwd),email(_email),phone(_phone),state(_state){}
//
...
// };
//
// void from_json(const json& j,_User& msg)
// {
...
// //class对象----->json对象
// void to_json(json& j,const _User& msg)
// {
//     j["id"] = msg.getid();
//     j["name"] = msg.getname();
